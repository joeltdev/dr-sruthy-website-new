    ...
    <section id="contact" className="section bg-soft relative overflow-hidden">
      ...
      <div className="container-p grid md:grid-cols-2 lg:grid-cols-2 gap-6 sm:gap-7 md:gap-8 items-stretch">
        ...
        <motion.div
          ...
          className="rounded-2xl border border-slate-200/70 bg-white/80 backdrop-blur-md p-6 sm:p-7 md:p-8 h-full shadow-sm transition-all hover:shadow-md"
        >
          ...
          <p className="mt-2 text-slate-600 text-sm md:text-base">Reach out for appointments, consultations, or general queries.</p>

          <div className="mt-5 grid text-[15px] md:text-base divide-y divide-slate-200/70 rounded-xl bg-white/40 ring-1 ring-slate-200/60 overflow-hidden">
            <div className="inline-flex items-center gap-3 py-3 px-3 sm:px-4 text-slate-700">
          ...
          <div className="mt-5 flex flex-col sm:flex-row gap-3">
            <button onClick={scrollToForm} className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full bg-primary-600 text-white px-5 py-3 sm:px-6 sm:py-3.5 text-[16px] sm:text-[17px] font-semibold shadow-sm hover:bg-primary-700 active:scale-[0.99] transition-all focus:outline-none focus:ring-4 focus:ring-primary-500/30">
        ...
        >
          ...
          <form id="contact-form" className="relative space-y-5 mt-4" onSubmit={handleSubmit}>
            <div className="space-y-1.5">
              <div className="relative group">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="peer w-full rounded-full ring-1 ring-transparent bg-slate-50 backdrop-blur-sm pl-14 sm:pl-14 pr-5 py-3.5 text-[15px] text-slate-900 placeholder-slate-500/90 shadow-sm transition-all duration-200 focus:bg-white focus:ring-0 focus:shadow-[0_6px_28px_rgba(2,132,199,0.10)] outline-none"
            ...
            <div className="space-y-1.5">
              <div className="relative group">
                ...
                <textarea
                  ...
                  name="message"
                  rows={4}
                  className="peer w-full rounded-2xl ring-1 ring-transparent bg-slate-50 backdrop-blur-sm pl-14 sm:pl-14 pr-5 py-3.5 text-[15px] text-slate-900 placeholder-slate-500/90 shadow-sm transition-all duration-200 focus:bg-white focus:ring-0 focus:shadow-[0_6px_28px_rgba(2,132,199,0.10)] outline-none min-h-[140px]"
                  placeholder="Message"
                  aria-label="Message"
                />
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 text-white px-7 py-4 sm:px-8 sm:py-4 text-[16px] sm:text-[17px] font-semibold shadow-sm hover:bg-slate-800 active:scale-[0.99] transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-slate-400/25"
              >
        ...
        <motion.div
          ...
          className="rounded-2xl border border-slate-200/70 bg-white overflow-hidden h-[360px] md:col-span-2 lg:col-span-2 shadow-sm"
        >
