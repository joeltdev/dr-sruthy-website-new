...
export default function Hero() {
  return (
    <section className="section bg-soft relative overflow-hidden pt-8 sm:pt-10 md:pt-12 lg:pt-1 pb-6 sm:pb-8 md:pb-12 lg:pb-3">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-br from-primary-50 via-pastel-lavender to-pastel-blue"
      />
        ...
        >
          <div className="relative w-full">
            <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
              <div className="absolute right-[-24px] md:right-[-40px] bottom-4 md:bottom-6 h-[360px] md:h-[480px] w-[360px] md:w-[480px] rounded-full bg-primary-200/25 blur-3xl" />
              <div className="absolute -right-2 sm:-right-4 md:-right-8 lg:-right-10 top-6 sm:top-8 md:top-6 lg:top-8 h-[340px] sm:h-[380px] md:h-[500px] lg:h-[560px] w-[160px] sm:w-[180px] md:w-[220px] lg:w-[260px] rounded-[120px] sm:rounded-[140px] md:rounded-[160px] lg:rounded-[180px] bg-gradient-to-b from-primary-200/25 via-primary-100/20 to-transparent blur-3xl rotate-6 sm:rotate-6 md:rotate-12 lg:rotate-12" />
              <div className="absolute -right-6 md:-right-10 top-8 md:top-10 h-56 w-56 md:h-72 md:w-72 rounded-full bg-gradient-to-br from-primary-200/50 via-pastel-lavender/40 to-pastel-blue/40 blur-3xl animate-drift-slower" />
              ...
              <div className="absolute inset-0 [mask-image:radial-gradient(white,transparent_70%)]">
                ...
                {/* Heartbeat */}
                <span className="absolute left-10 bottom-12 sm:left-12 sm:bottom-14 md:left-16 md:bottom-16 text-rose-400/25">
                ...
                {/* Syringe */}
                <span className="absolute right-14 bottom-10 text-violet-500/20">
            ...
            <div className="relative z-10 aspect-[4/5] md:aspect-[3/4] w-full grid place-items-center px-2 md:px-3 pb-0 mt-3 md:mt-4 mb-[-6px] md:mb-[-8px]">
              <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 flex items:end justify-center">
                <div className="h-[60%] md:h-[65%] w-[70%] md:w-[72%] rounded-full bg-primary-200/30 blur-3xl" />
              </div>
              <Image
